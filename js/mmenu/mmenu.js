...
(() => {
    ...
    class S {
        ...
        closePanel(e, t = !0, n = !0) {
            if (e && (e.matches(".mm-panel--opened") || e.parentElement.matches(".mm-listitem--opened"))) {
                if (this.trigger("closePanel:before", [e]),
        ...
        _initPanel(e) {
            var t;
            if (!e.matches(".mm-panel") && (b(e, this.conf.classNames.panel, "mm-panel"),
                ...
                if (this.trigger("initPanel:before", [e]),
                    ...
                    t.id = e.id,
                        ...
                        [].slice.call(e.classList).filter((e => "mm-" === e.slice(0, 3))).forEach((n => {
                            t.classList.add(n),
                                e.classList.remove(n)
                        }
                        )),
                        Object.keys(e.dataset).filter((e => "mm" === e.slice(0, 2))).forEach((n => {
                            t.dataset[n] = e.dataset[n],
                                delete e.dataset[n]
                        }
                        )),
                        e.before(t),
                ...
                return e.classList.add("mm-panel"),
        ...
        _initNavbar(e) {
            if (h(e, ".mm-navbar").length)
                return;
            let t = null
                , n = null;
            if (e.dataset.mmParent)
                for (t = d(this.node.pnls, `#${e.dataset.mmParent}`)[0],
                    n = t.closest(".mm-panel"); n.closest(".mm-listitem--vertical");)
                    n = n.parentElement.closest(".mm-panel");
            if (null == t ? void 0 : t.matches(".mm-listitem--vertical"))
                return;
            this.trigger("initNavbar:before", [e]);
            const s = c("div.mm-navbar");
            if (this.opts.navbar.add || s.classList.add("mm-hidden"),
                n) {
            ...
            const o = c("span");
            var r;
            o.innerHTML = e.dataset.mmTitle || ((r = i) ? [].slice.call(r.childNodes).filter((e => e.nodeType === Node.TEXT_NODE)).map((e => e.nodeValue.trim())).join(" ") : "") || this.i18n(this.opts.navbar.title || "Menu"),
                e.prepend(s),
                s.append(a),
                a.append(o),
        ...
        _initListview(e) {
            ["htmlulistelement", "htmlolistelement"].includes(s(e)) && (e.matches(".mm-listview") || (b(e, this.conf.classNames.nolistview, "mm-nolistview"),
                e.matches(".mm-nolistview") || (this.trigger("initListview:before", [e]),
        ...
        _initListitem(e) {
            ["htmllielement"].includes(s(e)) && (e.matches(".mm-listitem") || (b(e, this.conf.classNames.divider, "mm-divider"),
                e.matches(".mm-divider") || (this.trigger("initListitem:before", [e]),
        ...
        _initSubPanel(e) {
            if (e.matches(".mm-panel"))
                return;
            const t = e.parentElement;
            (e.matches("." + this.conf.classNames.vertical) || !this.opts.slidingSubmenus) && t.classList.add("mm-listitem--vertical"),
                t.id = t.id || i(),
                e.id = e.id || i(),
                t.dataset.mmChild = e.id,
                e.dataset.mmParent = t.id;
            let n = h(t, ".mm-btn")[0];
            n || (n = c("a.mm-btn.mm-btn--next.mm-listitem__btn"),
                h(t, "a, span").forEach((e => {
                    e.matches("span") ? (n.classList.add("mm-listitem__text"),
                        n.innerHTML = e.innerHTML,
                        t.insertBefore(n, e.nextElementSibling),
                        e.remove()) : t.insertBefore(n, e.nextElementSibling)
                }
                )),
                n.setAttribute("aria-label", this.i18n(this.conf.screenReader[t.matches(".mm-listitem--vertical") ? "toggleSubmenu" : "openSubmenu"]))),
                n.href = `#${e.id}`,
                this._initPanel(e)
        }
        _initOpened() {
            ...
            e && (this.setSelected(e),
                t = e.closest(".mm-panel")),
    ...
    S.prototype.open = function () {
        this.node.menu.matches(".mm-menu--opened") || (this.trigger("open:before"),
        ...
        S.prototype.close = function () {
            var e;
            this.node.menu.matches(".mm-menu--opened") && (this.trigger("close:before"),
                ...
                null === (e = this.node.open || document.querySelector(`[href="#${this.node.menu.id}"]`) || null) || void 0 === e || e.focus(),
    ...
    S.prototype.theme = function (e = null) {
        ...
        if (!e)
            return t;
        C.includes(e) && (this.node.menu.classList.remove(`mm-menu--theme-${t}`),
    ...
    function I() {
        ...
        if (void 0 !== e && (e instanceof Array || (e = [e]),
            e.length)) {
            var t = {};
            e.forEach((e => {
                if (!(e = function (e) {
    ...
    I.navbarContents = {
        ...
        prev: function (e) {
            ...
            e.append(t),
                ...
                this.bind("openPanel:before", (e => {
                    if (e.parentElement.matches(".mm-listitem--vertical"))
                        return;
    ...
    const F = function () {
        ...
        return n || (n = c("div.mm-panel--search"),
            K(n, t.panel),
        ...
        , z = function (e) {
            ...
            const a = () => {
                ...
                if (a.length ? e.classList.add("mm-searchfield--searching") : e.classList.remove("mm-searchfield--searching"),
                    !t.search)
                    return;
                const o = [];
                if (i.forEach((e => {
                    e.scrollTop = 0,
                        o.push(...d(e, ".mm-listitem"))
                }
                )),
                    a.length) {
                    this.trigger("search:before"),
                        ...
                        o.forEach((e => {
                            ...
                            var n;
                            (!t || (n = t,
                                [].slice.call(n.childNodes).filter((e => !e.ariaHidden)).map((e => e.textContent)).join(" ")).toLowerCase().indexOf(a) > -1) && (e.dataset.mmSearchresult = a)
                        }
                        ));
                    let e = 0;
                    ...
                    this.trigger("clear:before"),
                        ...
                        n.matches(".mm-panel--search") ? (U(n),
                            t.splash || this.closePanel(n, !1, !1)) : G(i),
            ...
            return t.forEach((t => {
                ...
                n += s.length,
                    ...
                    d(t, ".mm-listitem, .mm-divider").forEach((t => {
                        t.classList.add("mm-hidden"),
                            t.dataset.mmSearchresult === e && [t, ...p(t, ".mm-listitem")].forEach((e => {
    ...
    S.addons = {
        offcanvas: function () {
            ...
            e.use && (T.includes(e.position) || (e.position = T[0]),
                ...
                this.bind("initMenu:after", (() => {
                    this.setPage(S.node.page),
                        ...
                        this.node.menu.setAttribute("inert", "true"),
                        T.includes(e.position) && (this.node.wrpr.classList.add(`mm-wrapper--position-${e.position}`),
        ...
        scrollBugFix: function () {
            if (!A || !this.opts.offCanvas.use)
                return;
            if (this.opts.scrollBugFix = this.opts.scrollBugFix || {},
            ...
            const e = (e => {
                ...
                return e.addEventListener("touchstart", (e => {
                    1 === e.touches.length && (t = "",
                        n = e.touches[0].pageY)
                }
                )),
                    e.addEventListener("touchend", (e => {
                        0 === e.touches.length && (t = "",
                            n = null)
                    }
                    )),
                    e.addEventListener("touchmove", (e => {
                        if (t = "",
                            n && 1 === e.touches.length) {
        ...
        backButton: function () {
            if (this.opts.backButton = this.opts.backButton || {},
                ...
                this.bind("open:after", (() => {
                    ...
                    window.addEventListener("popstate", (() => {
                        if (this.node.menu.matches(".mm-menu--opened") && e.length) {
                            ...
                            n == t ? this.close() : (this.openPanel(this.node.menu.querySelector(n)),
                                history.pushState(null, "", location.pathname + location.search + t))
                        }
                    }
                    ))
        ...
        counters: function () {
            if (this.opts.counters = this.opts.counters || {},
        ...
        iconbar: function () {
            ...
            if (["top", "bottom"].forEach(((n, i) => {
                ...
                o.children.length && (t || (t = c("div.mm-iconbar")),
                    t.append(o))
            }
            )),
                t) {
                ...
                let n = "mm-menu--iconbar-" + e.position
                    ...
                    ;
                if ("boolean" == typeof e.use ? this.bind("initMenu:after", s) : g(e.use, s, i),
                    "tabs" == e.type) {
                    ...
                    const e = n => {
                        ...
                        if (s)
                            s.classList.add("mm-iconbar__tab--selected");
                        else {
        ...
        iconPanels: function () {
            ...
            if ("first" == e.visible && (t = !0,
                ...
                t ? this.bind("initMenu:after", (() => {
                    ...
                    if (t.closest(".mm-listitem--vertical"))
                        return;
        ...
        pageScroll: function () {
            ...
            if (this.opts.offCanvas.use && e.scroll && (this.bind("close:after", (() => {
                ...
                this.node.menu.addEventListener("click", (e => {
                    ...
                    (s = a(o)) && (e.preventDefault(),
                        this.node.menu.matches(".mm-menu--sidebar-expanded") && this.node.wrpr.matches(".mm-wrapper--sidebar-expanded") ? i() : this.close())
                }
                ))),
                e.update) {
                let e = [];
        ...
        sectionIndexer: function () {
            this.opts.sectionIndexer = this.opts.sectionIndexer || {},
                n(this.opts.sectionIndexer, X).add && this.bind("initPanels:after", (() => {
                    if (!this.node.indx) {
                        let e = "";
                        ...
                        let n = e => {
                            ...
                            let s = -1
                                , i = n.scrollTop;
                            n.scrollTop = 0,
                                d(n, ".mm-divider").filter((e => !e.matches(".mm-hidden"))).forEach((e => {
                            ...
                            ;
                        A ? (this.node.indx.addEventListener("touchstart", n),
                ...
                e.parent && (this.bind("openPanel:after", (e => {
                    ...
                    for (; t;) {
                        ...
                        t = null == e ? void 0 : e.closest(".mm-panel"),
                            e && !e.matches(".mm-listitem--vertical") && e.classList.add("mm-listitem--selected-parent")
                    }
                }
                )),
                    this.bind("initMenu:after", (() => {
